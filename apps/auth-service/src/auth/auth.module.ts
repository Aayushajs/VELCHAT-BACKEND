...
export class AuthModule {
  static forRoot(deps: AuthModuleDeps): DynamicModule {
    ...
    // JwtAuthGuard — register options token so NestJS DI can construct it (§B2.3 / §D4).
    // Without JWT_GUARD_OPTIONS_TOKEN, DI crashes: "argument Object at index [1] not available".
