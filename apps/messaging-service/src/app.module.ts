...
import { composeSingle, messagingGroup, type ServiceDeps } from '@velchat/composition';

export type AppDeps = ServiceDeps;
export { INFRA } from '@velchat/composition';

/**
 * messaging-service — one feature group in one process.
 *
...
export class AppModule {
  static forRoot(deps: AppDeps): DynamicModule {
    return composeSingle(AppModule, deps, messagingGroup(deps.config, deps.logger));
  }
}
