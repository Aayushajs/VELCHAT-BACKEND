// MUST be first: OpenTelemetry patches http/redis/pg/mongo at import time, so anything that loads
// an instrumented client before this line would go untraced.
