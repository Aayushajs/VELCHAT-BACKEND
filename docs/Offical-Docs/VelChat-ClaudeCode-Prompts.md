...
- libs/: proto (buf workspace), shared-types (generated), common (logger, tracer, kafkaClient, idempotency, tenant-context (ALS), authz guards, errors), config (zod env schema), crypto (libsignal wrapper stub)
